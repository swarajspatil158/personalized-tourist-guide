...
class MainPage extends Component {
  ...
  renderVenues() {
    if (this.state.venues.length) {
      ...
      return <Alert color="primary">No places found nearby you.</Alert>;
    } else {
      return (
      ...
      <div>
        <div className="container">
          ...
          <div className="text-center">
            {/* <h1 className="display-4">Personalized Tourist Guide</h1> */}
            <p className="lead mb-9">Find places near you</p>
